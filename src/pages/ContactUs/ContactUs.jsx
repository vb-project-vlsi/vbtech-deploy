            ...
            <div className={styles.contactSection}>
                ...
                <div className={styles.contactInfo}>
                    ...
                    <div className={styles.infoItem}>
                        ...
                        <span className={styles.text}>3524 SILVERSIDE RD STE 35B WILMINGTON, DE 19810-4929-520</span>
                    </div>
                </div>
            ...
            <div className={styles.contactSection}>
                ...
                <div className={styles.contactInfo}>
                    ...
                    <div className={styles.infoItem}>
                        ...
                        <span className={styles.text}><strong>HYDERABAD OFFICE :</strong> T-Hub Foundation ,GST No.36AAFCT4112L1ZB Plot No 1/C, Sy No.83/1,Hyderabad Knowledge City, Raidurgam, Email:madhusudhan.k@t-hub.co, PAN: AAFCT4112L, Place of Supply: Telangana ,Hyderabad, 500081.</span>
                    </div>
                </div>
                <div className={styles.socialMedia}>
                    <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className={styles.socialIcon}>
